...
export default function showImages (props){
    return (
      ...
      <h1>Kid to Kid</h1>
        ...
        //   <button id = "left-button" onClick = {props.handleClickNo}><img src={noun_wrong_1702071}/></button>
        //   <img src= {props.url} alt="item"/>
        //   <button id = "right-button" onClick = {props.handleClickYes}><img src={noun_like_1702075}/></button> 
        // </div>
